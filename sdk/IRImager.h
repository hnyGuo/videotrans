 ...
 */
typedef void (*fptrOptrisFrame)(unsigned short* data, unsigned int w, unsigned int h, IRFrameMetadata meta, void* arg);
 ...
 * @param[in] arg arbitrary user-defined argument (passed to process method)
 */
typedef void (*fptrOptrisVisibleFrame)(unsigned char* data, unsigned int w, unsigned int h, IRFrameMetadata meta, void* arg);
...
public:
   ...
   */
  bool init(IRDeviceParams* params, unsigned int frequency, unsigned int width, unsigned int height, bool realDevice=true, BaseControlDevice* dev=NULL);
   ...
   */
  bool reconnect(IRDeviceParams* params, unsigned int frequency, unsigned int width, unsigned int height, bool realDevice=true, BaseControlDevice* dev = NULL);
